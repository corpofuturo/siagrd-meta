...
const TIPO_STYLES: Record<TipoOrganismo, string> = {
  ...
  OTRO: 'bg-[#f3f4f6] text-[#6b7280] border border-[#e5e7eb]',
};
    ...
    <div className="flex-1">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-[#6b7280] text-sm mt-1">Directorio departamental del Meta — {filtrados.length} registro{filtrados.length !== 1 ? 's' : ''}</p>
        </div>
      ...
      {loading && <p className="text-[#6b7280] text-sm font-mono animate-pulse">Cargando directorio...</p>}
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#e5e7eb]">
                <th className="text-left px-4 py-3 text-xs text-[#6b7280] uppercase tracking-wider">Organismo</th>
                ...
                <th className="text-left px-4 py-3 text-xs text-[#6b7280] uppercase tracking-wider">Director</th>
            ...
            <tbody>
              {filtrados.map(org => (
                <tr key={org.id} className="border-b border-[#e5e7eb] last:border-0 hover:bg-[#f3f4f6] transition-colors">
                  <td className="px-4 py-3">
                    <p className="text-[#111827] font-semibold">{org.nombre}</p>
                  ...
                  <td className="px-4 py-3 text-[#6b7280] text-xs">{org.municipio_nombre ?? '—'}</td>
                  <td className="px-4 py-3 text-xs">
                    {org.director_nombre ? (
                      <div>
                        <p className="text-[#111827]">{org.director_nombre} {org.director_apellido}</p>
